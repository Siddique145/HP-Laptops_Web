        ...
        <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-gray-600 hover:text-gray-800">Desktops</a>
              </li>
              <li>
                <a className="text-gray-600 hover:text-gray-800">Monitors</a>
              </li>
              <li>
                <a className="text-gray-600 hover:text-gray-800">Printers</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-gray-600 hover:text-gray-800">Drivers & Software</a>
              </li>
              <li>
                <a className="text-gray-600 hover:text-gray-800">Product Registration</a>
              </li>
              <li>
                <a className="text-gray-600 hover:text-gray-800">Warranty Status</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-600 hover:text-gray-800">About HP</a>
              </li>
              <li>
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-gray-600 hover:text-gray-800">Chat</a>
              </li>
              <li>
