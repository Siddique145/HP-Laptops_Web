  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <h1 className="text-3xl font-medium title-font text-green-500 mb-12 text-center">
          Desktops
        </h1>
        <div className="flex flex-wrap -m-4">
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-gray-100 p-8 rounded">
              <img
                src="https://www.flashtrend.com.au/assets/full/Leader-MNHP-E24G5.jpg?20230526011522"
                alt=""
              />
              {/* <svg
              ...
              <p className="leading-relaxed mb-6">
                "Immerse yourself in vibrant, crystal-clear visuals with HP
                desktops featuring full LED screens, perfect for both work and
                play."
              </p>
          ...
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-gray-100 p-8 rounded">
              ...
              <p className="leading-relaxed mb-6">
                "HP desktops with full LED screens combine powerful performance
                with breathtaking visuals, making them ideal for creative
